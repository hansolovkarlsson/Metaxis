...
<body><header class="top"><a class="brand" href="index.html">Metaxis</a><nav class="site" aria-label="Site">{nav}<a href="{GH}">GitHub</a></nav></header>
<div class="wrap"><header class="masthead"><p class="eyebrow">{esc(navtitle)}</p><h1>{title}</h1></header>{rail}<main>{body}</main></div>
